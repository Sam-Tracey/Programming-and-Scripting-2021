...
elif score < 40:                                                                # check if value entered meets Fail criteria
    print ("Fail")
elif score < 50:                                                                # check if value entered meet Pass criteria
    print ("Pass")
elif score < 60:                                                                # check if value enterd meets Merit 2 criteria
    print ("Merit 2")
elif score < 70:                                                                # check if value entered meets Merit 1 criteria
    print ("Merit 1")
